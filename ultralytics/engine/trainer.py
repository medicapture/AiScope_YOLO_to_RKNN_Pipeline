        ...
        while True:
            ...
            for i, batch in pbar:
                ...
                with autocast(self.amp):
                    ...
                    #         print(f"batch {k} device = {v.device}")
                    # model_params_device = set()
                    # for params in self.model.parameters():
                    #     model_params_device.add(params.device)
                    # print(f"model params device = {model_params_device}")
        ...
        torch.save(
            {
                ...
                # "ema": deepcopy(self.ema.ema).half(), # TODO: 2024/11/28 for pruning
