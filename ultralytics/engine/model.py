...
# TODO: added 2024/11/28 for pruning
# from ultralytics.models.yolo.model import TASK_MAP
...
class Model(nn.Module):
    ...
    def export(
        ...
        **kwargs,
        ...
        print(f'image size = {custom["imgsz"]}, batch size = {custom["batch"]}')  # print image size for export
        args = {
            **self.overrides,
            **custom,
            **kwargs,
    ...
    def train(
        self,
        pruning: bool = False,  # TODO: added 2024/11/28
        trainer=None,
        **kwargs,
    ):
        """
        ...
        # print(f"data = {custom['data']}")  # print data for training
        args = {
            **overrides,
            **custom,
            **kwargs,
    ...
    def _smart_load(self, key: str):
        ...
        """
        try:
            # print("----------------------generating a new trainer----------------------")
            # idx_map = {'model': 0, 'trainer': 1, 'validator': 2, 'predictor': 3}
            # return TASK_MAP[self.task][idx_map[key]]
