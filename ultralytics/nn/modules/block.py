...
class C2f(nn.Module):
    ...
    def forward_split(self, x):
        ...
        if hasattr(self, 'cv0'):
            ...
            # channels = cv1_output.shape[1]
            # if channels % 2 == 0:
            #     # Even split
            #     first_half = second_half = channels // 2
            # else:
            #     # Uneven split
            #     first_half = channels // 2 + 1
            #     second_half = channels // 2
            # print(f"forward_split: c = {self.c}, cv1 = {self.cv1.conv.weight.shape[0]}, first_half = {first_half}, second_half = {second_half}")
            # y = list(cv1_output.split((first_half, second_half), 1))

            # print(f"forward_split: c = {self.c}, cv1 = {self.cv1.conv.weight.shape[0]}")
