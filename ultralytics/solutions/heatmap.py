...
from ultralytics.solutions.object_counter import (
    ObjectCounter,
)  # Import object counter class
...
class Heatmap(ObjectCounter):
    ...
    def generate_heatmap(self, im0):
        ...
        """
        self.heatmap = (
            np.zeros_like(im0, dtype=np.float32) * 0.99
        ...
        (
            self.display_counts(im0) if self.region is not None else None
